...
def MPT_MCMC_Macrostates(
    ...
    """Run stochastic MPT Algorithm from trajectory, calculate macrostates
    ...
    for i in tqdm(range(iterations)):
        transitions = MPT_MCMC(tmat, pop)
        decimals = len(str(iterations))
        linkage_file = state_traj + f'_MCMC_{i:0>{decimals}}_linkage.dat'
