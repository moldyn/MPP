...
MPP provides several metrics for evaluating lumping quality — implied timescales,
Shannon entropy, Davies-Bouldin index, GMRQ, RMSD sharpness, silhouette
coefficient, and Calinski-Harabász index. Each metric includes its mathematical
definition and literature reference.

See the dedicated [Quality Metrics](metrics.md) page for full details.
